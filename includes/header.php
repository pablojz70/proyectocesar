...
<div class="d-flex" id="wrapper">
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column sidebar-nav">
            ...
            <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/modules/sales/history.php" onclick="closeSidebar()"><img src="<?= BASE_URL ?>/imagen/5ventas.png" class="sidebar-icon" alt=""> Ventas</a></li>
