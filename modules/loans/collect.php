...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body p-0">
            <table class="table table-sm mb-0">
                <thead><tr><th>#</th><th>Fecha Pago</th><th>Monto</th><th>Moneda</th><th>MoraP</th><th>Inter&eacute;sA</th><th>Total Abonado</th><th class="no-print">Acci&oacute;n</th></tr></thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $loan['currency'] ?></td>
                        <td><?= $mora_p ?></td>
                        <td><?= number_format($interes_acum,2) ?></td>
